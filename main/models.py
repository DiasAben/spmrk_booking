...
class BookingSettings(models.Model):
    ...
    training_name = models.CharField(max_length=1000, null=True, blank=True)
    ...
    def __str__(self) -> str:
        return self.training_name or "(No Name)"
...
class Booking(models.Model):
    ...
    training_name = models.ForeignKey(BookingSettings, on_delete=models.CASCADE)
